    ...
    function(t) {
        t.host = function() {
            var t = window.location.protocol,
                e = "";
            return e = t.indexOf("https") > -1 || window.location.hostname.indexOf("163") < 0 ? "./js": "http://res.nie.netease.com"
        } ()
    } (jQuery),
    !
        function(t) {
...
var ADBase = function(t) {
    ...
    function(t) {
        nie.util.topBar = nie.util.topBar ||
            function() { ! nie.config.topBar.hasRun && document.getElementById("NIE-topBar") && (nie.config.topBar.hasRun = !0, t.include(t.host + "/topBar.v2.last.js")),
